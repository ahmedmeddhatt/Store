...
const getAllProductsForOrder = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const allProducts = yield order.getAllProductsForOrder(req.params.order_id);
...
const addProductToOrder = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const addedProduct = yield order.addProductToOrder(req.params.order_id, req.body.product_id, req.body.quantity);
        res.json({
...
const deleteProductFromOrder = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const deletedProduct = yield order.deleteProductFromOrder(req.params.order_id, req.body.product_id);
        res.json({
...
const updateProductQuantityInOrder = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const updatedProduct = yield order.updateProductQuantityInOrder(req.params.order_id, req.body.product_id, req.body.quantity);
        res.json({
